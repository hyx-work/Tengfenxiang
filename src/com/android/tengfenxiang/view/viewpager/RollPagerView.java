...
public class RollPagerView extends RelativeLayout implements
	...
	private void initView(AttributeSet attrs) {
		...
		gravity = type.getInteger(
				R.styleable.RollViewPager_rollviewpager_hint_gravity, 1);
		...
		addView(mViewPager);
		type.recycle();
		initHint(new ColorPointHintView(getContext(),
				Color.parseColor("#E3AC42"), Color.parseColor("#88ffffff")));
	}
			...
			if (rollPagerView != null) {
				if (rollPagerView.isShown()
						&& System.currentTimeMillis()
								- rollPagerView.mRecentTouchTime > rollPagerView.delay) {
